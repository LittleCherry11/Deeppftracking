...
def main(args):
    ...
    for id in np.arange(0,nFrame):#nFrame
        ...
        if id == 0:
            ...
            filter.predict_particles(Q=0.02,cr=0.05,ca=0.05)#0.02,0.0005,0.005
            filter.restrict_particles(w,h)
            area_hist.append(filter.cur_a)
            #compute conf
...
if __name__=='__main__':
    ...
    #parser.add_argument("--prototxt", default='res101_align_res2c.prototxt', type=str)#res3b
    #parser.add_argument("--caffemodel", default='resnet/ResNet-101-model.caffemodel', type=str)
    ...
    parser.add_argument("--prototxt", default='vgg16_align_conv4.prototxt', type=str)
    ...
    parser.add_argument("--sequence", default="FaceOcc1", type=str)
